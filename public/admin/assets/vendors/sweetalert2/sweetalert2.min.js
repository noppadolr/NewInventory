!(function (e, t) {
    ...
    const a = { previousBodyPadding: null },
        ...
        Ce = () => {
            x.previousActiveElement instanceof HTMLElement
                ? (x.previousActiveElement.focus(),
                  (x.previousActiveElement = null))
                ...
                n.progressSteps.forEach((e, t) => {
                    ...
                    o.appendChild(e),
                        t === n.currentProgressStep &&
                            w(e, p["active-progress-step"]),
                        t !== n.progressSteps.length - 1 &&
                            ((e = ((e) => {
                                const t = document.createElement("li");
                                if (
                                    (w(t, p["progress-step-line"]),
            ...
            "function" == typeof n.willClose && n.willClose(t),
                s
                    ? ((s = e),
                      ...
                      (i = n.returnFocus),
                      (r = n.didClose),
                      (x.swalCloseEventFinishedCallback = Rt.bind(
                          null,
                          s,
                          t,
                          i,
    ...
    e = Object.freeze({
        ...
        getInput: function (e) {
            ...
            return (e = T.domCache.get(e || this))
                ? de(e.popup, t.input)
                : null;
        },
        close: Ft,
        ...
        _main(e) {
            var t =
                ...
                e =
                    (X(Object.assign({}, t, e)),
                    x.currentInstance &&
                        (x.currentInstance._destroy(), se() && rt()),
                    (x.currentInstance = j),
                    hn(e, t)),
                t =
                    (ht(e),
